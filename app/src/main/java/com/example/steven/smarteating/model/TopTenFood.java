...
/**
 * Created by steven on 10/2/2018.
 */

public class TopTenFood {
    ...
    public TopTenFood(String food_ID, String food_Name, double category, double energy, double carbohydrates, double protein, double dietary_fibre, double total_fat, double total_sugars, double vitamin_B1, double vitamin_B2, double vitamin_B3, double vitamin_B6, double vitamin_B12, double vitamin_C, double vitamin_E, double vitamin_A, double total_Folates, double calcium, double iodine, double iron, String show_Name, double magnesium, double phosphorus, double potassium, double selenium, double sodium, double zinc, double cholesterol, double starch) {
